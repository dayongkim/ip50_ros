// _ip50_DRIVER_HPP_
#ifndef _ip50_DRIVER_HPP_
#define _ip50_DRIVER_HPP_
...
#include <ip50_msgs/RobotMotor.h>

#define PI 3.141592
#define WHELL_DIAMETER 0.130
#define WHELL_WITH 0.433
...
namespace aidl
{
	...
	public:
		// constructor
		ip50BodyNode(ros::NodeHandle *nh) : x_(0), y_(0), th_(0), delta_x_(0), delta_y_(0), delta_th_(0), vx_(0), vy_(0), vth_(0),
		...
		void rpm_vel_callback(const ip50_msgs::RobotMotor &msg)
		{
		...
		{
			// [m/s]
			ip50_msgs::RobotMotor motor_msg;
